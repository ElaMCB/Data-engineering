...
#### 1. Autonomous AI Testing Agent (Data Engineering Portfolio)
**Location**: `projects/02-etl-pipeline-framework/AI_TESTING_AGENT.md`
...
**Key Capabilities:**
- Zero human intervention for routine testing
- Self-healing when pipelines change
- Cost-effective (serverless architecture)

#### 2. IDE Agentic Workflow (Cursor)
**What You Mentioned:**
...
#### 3. AI Agents for QA Research
**Location**: `research/notebooks/ai-agents-qa-healthcare.ipynb`
...
- **Your Existing Agents**: Review `projects/02-etl-pipeline-framework/AI_TESTING_AGENT.md`
- **Research**: See `research/notebooks/ai-agents-qa-healthcare.ipynb`
